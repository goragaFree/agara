...
public class TargetHud extends HudElement {
      ...
      if (this.target != null) {
         ...
         if (this.animation.getValue() != 0.0F) {
            ...
            context.drawRightText(
               semibold6, numberText, this.x + this.width - 7.0F, this.y + 4.0F + 6.0F * this.content.getValue(), Colors.getAccent().withAlpha(alpha)
            );
            ...
            context.drawRoundedRect(
               ...
               3.0F,
               BorderRadius.all(0.7F),
               Colors.getAccent().withAlpha(alpha)
            );
            context.drawRoundedRect(
   ...
   public void onMouseClicked(double mouseX, double mouseY, MouseButton button) {
      if (GuiUtility.isHovered(this.x + 30.0F, this.y + 3.0F + 6.0F * this.content.getValue(), 60.0, 6.0, mouseX, mouseY)) {
