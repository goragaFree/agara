...
public class NotificationStatus extends IslandStatus {
   ...
   public void draw(CustomDrawContext context) {
      ...
      if (!notifications.isEmpty()) {
         Notification active = (Notification)notifications.getLast();
   ...
   public boolean canShow() {
      List<Notification> notifications = Rockstar.getInstance().getNotificationManager().getNotifications();
      return !notifications.isEmpty() && !((Notification)notifications.getLast()).getTimer().finished(((Notification)notifications.getLast()).getDuration());
   }
}
