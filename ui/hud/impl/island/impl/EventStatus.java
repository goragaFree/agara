...
public class EventStatus extends TimerStatus {
                  ...
                  if (eventName.toLowerCase().contains(value.getName().toLowerCase())) {
                     ...
                     if (this.an == ServerUtility.ftAn) {
                        Rockstar.getInstance()
                           .getWayPointsManager()
                           .add(
                              ((EventStatus.ActiveEvent)this.activeEvents.getFirst()).type.getName(),
   ...
   public void draw(CustomDrawContext context) {
      ...
      if (!this.activeEvents.isEmpty()) {
         EventStatus.ActiveEvent currentEvent = (EventStatus.ActiveEvent)this.activeEvents.getFirst();
   ...
   enum EventType {
      ...
      @Generated
      EventType(final String name, final long time) {
         this.name = name;
         this.time = time;
      }
   }
