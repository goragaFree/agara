...
public final class Utils implements IMinecraft {
   ...
   public static Vec2f worldToScreen(Vec3d worldCoords) {
      if (worldCoords != null && modelViewMatrix != null && projectionMatrix != null && mc.player != null && mc.gameRenderer != null) {
         ...
         return Float.isFinite(screenX) && Float.isFinite(screenY) ? new Vec2f(screenX, screenY) : null;
      } else {
         return null;
      }
   }
