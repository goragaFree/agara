...
import moscow.rockstar.framework.shader.impl.FogBlurPost;
...
public final class DrawUtility implements IMinecraft, IWindow {
   ...
   public static void initializeShaders() {
      ...
      skyNebulaProgram = new SkyShaderProgram(Rockstar.id("sky_nebula/data"));
      skyCausticProgram = new SkyShaderProgram(Rockstar.id("sky_caustic/data"));
