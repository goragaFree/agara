   ...
   public void registerAnimationFromPenisFile(Identifier penisFile) {
      try {
         ...
         try (
            ...
            Map<String, byte[]> frameData = new TreeMap<>();
      ...
      if (this.isBuilt) {
         ...
         for (int x = 0; x < atlasWidth; x++) {
            for (int y = 0; y < atlasHeight; y++) {
               ((NativeImageAccessor)(Object)atlasImage).invokeSetColor(x, y, 0);
            }
         }
         ...
         for (int frameIndex = 0; frameIndex < totalFrames; frameIndex++) {
            ...
            for (int x = 0; x < this.frameWidth; x++) {
               for (int y = 0; y < this.frameHeight; y++) {
                  ((NativeImageAccessor)(Object)atlasImage)
                     .invokeSetColor(atlasX + x, atlasY + y, ((NativeImageAccessor)(Object)sourceFrame).invokeGetColor(x, y));
               }
            }
         }
