   ...
   static class Info {
      ...
      void draw(PreHudRenderEvent e) {
         ...
         if (screenPos != null) {
            ...
            e.getContext()
               .drawRoundedRect(
                  x - 3, 2.0F, width + 24, Fonts.MEDIUM.getFont(11.0F).height() + 9.0F, BorderRadius.top(3.0F, 3.0F), new ColorRGBA(0.0F, 0.0F, 0.0F, 100.0F)
               );
            e.getContext()
               .drawRoundedRect(
                  x - 3,
            ...
            e.getContext().drawItem(this.type.getItem(), x, 3.0F, 0.75F);
            matrices.pop();
         }
      }
