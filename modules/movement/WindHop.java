...
public class WindHop extends BaseModule {
   ...
   private void swapElytraChestplate() {
      ...
      ItemSlot chestplateItemSlot = slotsToSearch.findItem(
         itemStack -> itemStack.getItem() instanceof ArmorItem armorItem && ((ArmorItemAddition)armorItem).rockstar$getType() == EquipmentType.CHESTPLATE
      );
      ...
      if (mc.world != null && mc.player != null && mc.interactionManager != null) {
         ...
         if (slot != null) {
            ...
            ((ClientPlayerInteractionManagerAccessor)mc.interactionManager)
               .invokeSendSequencedPacket(mc.world, sequence -> new PlayerInteractItemC2SPacket(hand, sequence, finalYaw, pitch));
